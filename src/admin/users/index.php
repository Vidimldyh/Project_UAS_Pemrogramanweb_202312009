...
<head>
    ...
    <title>Manajemen User - Azta Es Cream</title>
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-9 main-content">
            <div class="content-header">
                ...
                <p>Kelola pengguna, peran, dan akses untuk sistem Azta Es Cream</p>
            </div>
                        ...
                        <tbody>
                            <?php $no=1; while($u = mysqli_fetch_assoc($users)) { 
                                ...
                                if ($u['role'] == 'admin') {
                                    ...
                                    $role_class = 'badge-inactive';
                                }
                                
                                // Get first letter of name for avatar
                                $avatar_letter = strtoupper(substr($u['nama'], 0, 1));
                            ?>
                            <tr>
                                <td data-label="#"><?= $no++; ?></td>
                                ...
                                <td data-label="Role">
                                    <span class="badge-custom <?= $role_class; ?>">
                                        <?= ucfirst($u['role']); ?>
                                    </span>
                                </td>
                                <td data-label="Aksi">
                                    <div class="btn-action">
                                        <a href="edit.php?id=<?= $u['id_user']; ?>" class="btn-edit">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <a href="hapus.php?id=<?= $u['id_user']; ?>" class="btn-delete" onclick="return confirm('Hapus user ini?')">
