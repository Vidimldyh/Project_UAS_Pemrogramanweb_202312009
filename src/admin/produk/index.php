...
$query = mysqli_query($conn, "SELECT produk.*, kategori.nama_kategori FROM produk 
...
<head>
    ...
    <title>Manajemen Produk - Azta Es Cream</title>
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-9 main-content">
            <div class="content-header">
                <h1><i class="fas fa-ice-cream me-2"></i>Manajemen Produk</h1>
                <p>Kelola produk es krim, kategori, stok, dan harga untuk toko Azta Es Cream</p>
            </div>
                    ...
                    <table class="table-custom">
                        ...
                        <tbody>
                            <?php $no = 1; while ($row = mysqli_fetch_assoc($query)) { 
                                $stok_class = '';
                                if ($row['stok'] > 20) {
                                    $stok_class = 'badge-stock';
                                } else if ($row['stok'] > 0) {
                                    $stok_class = 'badge-low';
                                } else {
                                    $stok_class = 'badge-out';
                                }
                            ?>
                            <tr>
                                ...
                                <td data-label="Stok">
                                    <span class="badge-custom <?= $stok_class; ?>">
                                        <?= $row['stok']; ?> pcs
                                    </span>
                                </td>
                                <td data-label="Aksi">
                                    <div class="btn-action">
                                        ...
                                        <a href="hapus.php?id=<?= $row['id_produk']; ?>" class="btn-delete" onclick="return confirm('Yakin hapus produk ini?')">
