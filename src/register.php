...
if (isset($_POST['register'])) {
    ...
    if (mysqli_num_rows($cek) > 0) {
        ...
        $query = mysqli_query($conn, "INSERT INTO users (nama, email, password, role, created_at) 
            VALUES ('$nama', '$email', '$password', 'pelanggan', NOW())");
...
<head>
    ...
    <title>Registrasi - Azta Es Cream</title>
    ...
    <div class="container">
        <div class="card" id="register-card">
            <div class="card-header">
                ...
                <h2 class="card-title">Daftar Akun Pelanggan</h2>
                <div class="card-subtitle">Mulai nikmati berbagai es krim lezat</div>
            </div>
            <div class="card-body">
                <form method="post">
